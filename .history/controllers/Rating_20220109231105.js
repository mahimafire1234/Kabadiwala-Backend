...
exports.giveRating = async(req,res) => {
    ...
    if(companyRating.length>= 1){
        ...
        createModel.save();
        res.status(201).json({success:true,message:createModel});
        ...
        createModel.save().then(result => res.status(201).json({success:true,message:"You have successfully added rating"});
