...
exports.insertRate = (req, res, next) => {
    console.log(+req.body.rate["category"])
    let a = req.body.rate
    console.log("This is type of a:"+typeof(a))
    console.log("This is type of a:"+a.category)
    Category.find({ userID: req.body.userID,rate:req.body.rate})
